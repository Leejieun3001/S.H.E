CREATE DATABASE  IF NOT EXISTS `somini` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
USE `somini`;
...
CREATE TABLE `post` (
  ...
  `likes_cnt` int(11) NOT NULL DEFAULT '0',
  ...
  `coment_cnt` int(11) DEFAULT NULL,
  PRIMARY KEY (`p_idx`),
...
-- Dump completed on 2020-03-18 16:09:45
