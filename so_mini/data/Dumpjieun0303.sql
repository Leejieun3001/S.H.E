...
CREATE TABLE `comment` (
  ...
  `c_regist_datetime` datetime NOT NULL,
  PRIMARY KEY (`c_idx`),
  KEY `p_idx` (`p_idx`),
...
CREATE TABLE `following` (
  `user_id` varchar(20) NOT NULL,
  `following_nickname` varchar(20) NOT NULL,
  `following_idx` int NOT NULL,
  PRIMARY KEY (`user_id`,`following_idx`),
  KEY `follwing_idx_idx` (`following_idx`),
  CONSTRAINT `follwing_idx` FOREIGN KEY (`following_idx`) REFERENCES `user` (`u_idx`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-03-03 14:00:50
